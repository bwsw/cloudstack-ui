...
3. Service offerings -  A set of options and resources that users can choose from, such as templates for creating virtual machines, disk storage, and more. Select a small instance or a medium instance, or custom (?). The Custom offering option allows to set your own settings for:
